...
class VariantSelects extends HTMLElement {
  ...
  updateVariantInput() {
    //stock counter alert INDICATEUR DE STOCK
    ...
    if (document.getElementById('unseenclass')) {
      ...
      if (varQuantity > indicNum) {
        ...
        document.querySelector('.stock-disp').style.color = 'green';
        ...
        document.querySelector('.stock-disp').style.color = 'orange';
        document.querySelector('.stock-indic').style.background = 'orange';
      } else if (varQuantity <= 0) {
        document.querySelector('.stock-disp').innerHTML = `Indisponible`;
        document.querySelector('.stock-disp').style.color = 'red';
...
// Animation bouton scroll ~ Shopiweb
$(function() {
...
$(document).ready(function() {
  ...
  function addcook(){
    var now = new Date();
    var expires = new Date(now.getTime() + 90 * 24 * 60 * 60 * 1000); // 90 jours en millisecondes
    document.cookie = "cooks=true;expires=" + expires.toUTCString();
    $(".cookie-popup").addClass("hidepops");
  }
  ...
  function refused(){
    var now = new Date();
    var expires = new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000); // 30 jours en millisecondes
    document.cookie = "cooks=true;expires=" + expires.toUTCString();
    $(".cookie-popup").addClass("hidepops");
  }
